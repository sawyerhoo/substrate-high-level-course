...
//! HOSTNAME: `liu-laptop`, CPU: `13th Gen Intel(R) Core(TM) i9-13900HX`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// The range of component `d` is `[0, 10]`.
	fn revoke_claim(d: u32, ) -> Weight {
		(17_961_593 as Weight)
			// Standard Error: 123_448
			.saturating_add((877_726 as Weight).saturating_mul(d as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	// Storage: PoeModule Proofs (r:1 w:1)
	...
	/// The range of component `d` is `[0, 10]`.
	fn transfer_claim(d: u32, ) -> Weight {
		(12_369_026 as Weight)
			// Standard Error: 15_310
			.saturating_add((58_679 as Weight).saturating_mul(d as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
}
